...
parser.add_argument("--train_vocab", type=str, default='tasks/CVDN/data/train_vocab.txt')
parser.add_argument("--trainval_vocab", type=str, default='tasks/CVDN/data/trainval_vocab.txt')
parser.add_argument("--imagenet_features", type=str, default='img_features/ResNet-152-imagenet.tsv')
parser.add_argument('--train_datasets', type=str, default='CVDN_NDH', help='underscore separated training list')
parser.add_argument('--eval_datasets', type=str, default='CVDN', help='underscore separated eval list')
